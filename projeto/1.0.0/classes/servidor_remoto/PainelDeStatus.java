...
public class PainelDeStatus extends JPanel{
...
public Color cor_fundo;
	...
	public PainelDeStatus(Color cor_fonte, Color cor_fundo){
	...
	private void setConfiguracaoDeMonitor(){
		...
		if(monitor!=null){	
			...
			if(monitor.servidor.getSincronizar()!=null && monitor.servidor.getSincronizar().compareTo("SIM")==0){
