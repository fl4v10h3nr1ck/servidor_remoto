...
private String sincronizacao_manual;
...
private Monitor monitor;
	...
	Preferences preferences	= null;
		...
		this.sincronizacao_manual=preferences.get("sincronizar", "SIM");
		}
	...
	String retorno = "";	
		...
		.bodyForm(form.build(), Consts.UTF_8).execute().returnContent().asString());
			...
			this.monitor.setConsole("Servidor não respondeu. Servidor indisponível.");
	...
	public String sincronizacaoManual(){return this.sincronizacao_manual;}
	...
	Map<String, Object> valores = new HashMap<String, Object>();
	valores.put("ERRO_COD", "ERRO_DE_CONEXAO");
